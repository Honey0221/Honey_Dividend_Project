...
import com.Honey.exception.impl.NoCompanyException;
import com.Honey.model.Company;
import com.Honey.model.ScrapedResult;
import com.Honey.persist.CompanyRepository;
import com.Honey.persist.DividendRepository;
import com.Honey.persist.entity.CompanyEntity;
import com.Honey.persist.entity.DividendEntity;
import com.Honey.scraper.Scraper;
...
public class CompanyService {
    ...
    private Company storeCompanyAndDividend(String ticker) {
        ...
        List<DividendEntity> dividendEntities = scrapedResult.getDividends()
                                                .stream()
                                                .map(e -> new DividendEntity(
                                                        companyEntity.getId(), e))
