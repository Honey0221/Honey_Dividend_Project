...
import com.Honey.model.constants.Month;
...
public class YahooFinanceScraper implements Scraper {
    ...
    private static final String STATISTICS_URL =
            "https://finance.yahoo.com/quote/%s/history?period1=%d&period2=%d&frequency=1mo";
    ...
    public ScrapedResult scrap(Company company) {
        ...
        try {
            ...
            Elements parsingDivs = document.select("table.table.svelte-ewueuo");
